...
Restaurant.create(resname: '배터지는파닭(신림점)',phone:'02-877-7982',resinfo:'둘이 먹고도 남을 푸짐한 양에 반하다!!',restype:'중식',tastepoint:5,speedpoint:5,amountpoint:5,speedpoint:5,count:1)
